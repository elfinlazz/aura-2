...
public class LassarBaseScript : NpcScript
{
	...
	protected override async Task Keywords(string keyword)
	{
		switch(keyword)
		{
			...
			case "about_study":
				...
				Close2("<npcportrait name='NONE' /><title name='NONE' />Goodbye, Lassar. I'll see you later!");
				break;
	...
	{
		Close("<npcportrait name='NONE' /><title name='NONE' />Goodbye, Lassar. I'll see you later!");
	}	
}
